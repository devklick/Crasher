...
import ActiveRoundRow from "./active_round_table";
import BetRow from "./bet_table";
import CompletedRoundRow from "./completed_round_table";
import GameDefinitionRow from "./game_definition_table";
...
const tablesSchema = __schema({
  ...
  CompletedRound: __table({
    name: 'completed_round',
    indexes: [
      { name: 'Id', algorithm: 'btree', columns: [
        'id',
      ] },
    ...
    constraints: [
      { name: 'completed_round_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, CompletedRoundRow),
  GameDefinition: __table({
